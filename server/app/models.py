...
class FamilyProfile(Base):
    ...
    relation_type: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    ...
    emergency_contact: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    favorite_hospital: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    favorite_pharmacy: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
...
class FamilyMember(Base):
    ...
    linked_user_id: Mapped[Optional[int]] = mapped_column(ForeignKey("users.id"), nullable=True)
...
class HealthProfile(Base):
    ...
    allergies: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    chronic_diseases: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    pregnancy_status: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    emergency_contact: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    current_medications: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class FavoritePlace(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id"), nullable=False)
    profile_id: Mapped[Optional[int]] = mapped_column(ForeignKey("family_profiles.id"), nullable=True)
    place_id: Mapped[str] = mapped_column(String(100), nullable=False)
    place_name: Mapped[str] = mapped_column(String(160), default="")
    place_type: Mapped[str] = mapped_column(String(30), nullable=False)
    address: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    phone: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    distance_km: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    hours: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    operating_status: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    closes_at: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    latitude: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    longitude: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
...
class MedicineSearchHistory(Base):
    ...
    profile_id: Mapped[Optional[int]] = mapped_column(ForeignKey("family_profiles.id"), nullable=True)
    medicine_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
...
class Medication(Base):
    ...
    alias: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    product_name: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    ingredient: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    manufacturer: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    dosage: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    ...
    imprint: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    image_url: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    purpose: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    taking_method: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    timing: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    memo: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    dur_warnings: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class MedicationSchedule(Base):
    ...
    ends_on: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)
    ...
    week_interval: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    monthly_mode: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    month_days: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    monthly_week_ordinal: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    monthly_weekday: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    missing_date_policy: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    ...
    cycle_active_days: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    cycle_rest_days: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    max_daily_notifications: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    relation_offset_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    reminder_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    reminder_interval_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    reminder_max_count: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    guardian_alert_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    guardian_alert_delay_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    paused: Mapped[bool] = mapped_column(Boolean, default=False)
    pause_reason: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
...
class MedicationEvent(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    medication_id: Mapped[int] = mapped_column(ForeignKey("medications.id"), nullable=False)
    schedule_id: Mapped[Optional[int]] = mapped_column(ForeignKey("medication_schedules.id"), nullable=True)
    profile_id: Mapped[Optional[int]] = mapped_column(ForeignKey("family_profiles.id"), nullable=True)
    scheduled_at: Mapped[str] = mapped_column(String(40), nullable=False)
    status: Mapped[str] = mapped_column(String(20), default="pending")
    taken_at: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
...
class FacilityReport(Base):
    ...
    reporter_contact: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="pending")
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class EmergencyShare(Base):
    ...
    guardian_contact: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    room_id: Mapped[str] = mapped_column(String(100), nullable=False)
    room_name: Mapped[str] = mapped_column(String(160), nullable=False)
    room_phone: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    latitude: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    longitude: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
