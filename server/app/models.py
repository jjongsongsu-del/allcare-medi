...
class FavoritePlace(Base):
    ...
    hours: Mapped[str | None] = mapped_column(String(160), nullable=True)
    operating_status: Mapped[str | None] = mapped_column(String(30), nullable=True)
...
class MedicationSchedule(Base):
    ...
    week_interval: Mapped[int | None] = mapped_column(Integer, nullable=True)
    monthly_mode: Mapped[str | None] = mapped_column(String(20), nullable=True)
    month_days: Mapped[str | None] = mapped_column(Text, nullable=True)
    monthly_week_ordinal: Mapped[int | None] = mapped_column(Integer, nullable=True)
    monthly_weekday: Mapped[int | None] = mapped_column(Integer, nullable=True)
    missing_date_policy: Mapped[str | None] = mapped_column(String(20), nullable=True)
    interval_hours: Mapped[int | None] = mapped_column(Integer, nullable=True)
    interval_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    cycle_active_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    cycle_rest_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    max_daily_notifications: Mapped[int | None] = mapped_column(Integer, nullable=True)
    relation_offset_minutes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    reminder_max_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    guardian_alert_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    guardian_alert_delay_minutes: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class EmergencyShare(Base):
    ...
    room_phone: Mapped[str | None] = mapped_column(String(80), nullable=True)
    latitude: Mapped[str | None] = mapped_column(String(40), nullable=True)
    longitude: Mapped[str | None] = mapped_column(String(40), nullable=True)
