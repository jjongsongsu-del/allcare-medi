...
export const emergencyRooms: EmergencyRoom[] = [
  {
    ...
    distanceKm: 0.52,
    availableBeds: 8,
    emergencyGeneralBeds: 8,
    operatingRooms: 2,
    icuBeds: 4,
    inpatientBeds: 32,
    pediatricBeds: 3,
    negativeIsolationBeds: 1,
    generalIsolationBeds: 2,
    emergencyIcuBeds: 2,
    pediatricIcuBeds: 1,
    emergencyInpatientBeds: 6,
    pediatricInpatientBeds: 2,
    deliveryRoomBeds: 1,
    traumaResuscitationBeds: 1,
    traumaCareAreaBeds: 2,
    ...
    ctAvailable: true,
    mriAvailable: true,
    angiographyAvailable: true,
    ventilatorAvailable: true,
    ambulanceAvailable: true,
    doctorOnDuty: "당직의 확인 필요",
    emergencyDirectPhone: "02-119-0001",
    pediatricDirectPhone: "02-119-0012",
    dataNote: "응급실 일반 병상(hvec), 소아(hv28), 응급실 격리(hv29/hv30), 입력일시(hvidate)는 국립중앙의료원 응급의료정보조회서비스 V4 기준입니다.",
  ...
  },
  {
    ...
    distanceKm: 3.8,
    availableBeds: 2,
    emergencyGeneralBeds: 2,
    operatingRooms: 1,
    icuBeds: 1,
    inpatientBeds: 14,
    pediatricBeds: 1,
    negativeIsolationBeds: 0,
    generalIsolationBeds: 1,
    emergencyIcuBeds: 0,
    pediatricIcuBeds: 0,
    emergencyInpatientBeds: 2,
    pediatricInpatientBeds: 0,
    deliveryRoomBeds: 0,
    traumaResuscitationBeds: 0,
    traumaCareAreaBeds: 0,
    pediatricEmergency: true,
    deliveryRoom: false,
    isolationRoom: true,
    severeCare: false,
    ctAvailable: true,
    mriAvailable: false,
    angiographyAvailable: false,
    ventilatorAvailable: true,
    ambulanceAvailable: false,
    doctorOnDuty: "당직의 확인 필요",
    emergencyDirectPhone: "02-119-0002",
    pediatricDirectPhone: undefined,
    dataNote: "응급실 일반 병상(hvec), 소아(hv28), 응급실 격리(hv29/hv30), 입력일시(hvidate)는 국립중앙의료원 응급의료정보조회서비스 V4 기준입니다.",
